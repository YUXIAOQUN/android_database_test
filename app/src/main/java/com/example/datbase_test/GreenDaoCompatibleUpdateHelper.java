    ...
    private static boolean generateTempTables_withExchangeDataFromOldTable(StandardDatabase db, Class<? extends AbstractDao<?, ?>>... daoClasses) {
        try {
            for (int i = 0; i < daoClasses.length; i++) {
                ...
                Log.d("cacacaca", "daoConfig="+daoConfig.toString());
                Log.d("cacacaca", "tableName="+tableName);
                Log.d("cacacaca", "insertTableStringBuilder.toString()="+insertTableStringBuilder.toString());
